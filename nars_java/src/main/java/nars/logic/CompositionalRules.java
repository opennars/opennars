    ...
    private static boolean decomposeCompound(CompoundTerm compound, Term component, Term term1, int index, boolean compoundTask, int order, NAL nal) {
        ...
        if (truth != null) {
            return nal.doublePremiseTask(content, truth,
                    BudgetFunctions.compoundForward(truth, content, nal),
                    nal.newStamp(sentence, belief), false);
        }
        return false;
    }
        ...
        if (taskSentence.isQuestion() || taskSentence.isQuest()) {
            ...
            if (taskSentence.term.hasVarQuery()) {
                ...
                if (conj != null) {
                    ...
                    nal.doublePremiseTask(conj, truth, budget, nal.newStamp(belief, contentBelief), false, belief, contentTask);
                }
            }
        } else {
            TruthValue v1, v2;
    ...
    public static void introVarOuter(final Statement taskContent, final Statement beliefContent, final int index, final NAL nal) {
...

        {
            ...
            if (ct!=null) {
                ...
                nal.doublePremiseTask(ct, truth, budget, stamp, false);
            }
        }
...

        {
            ...
            if (content != null) {
                ...
                if (ct != null) {
                    ...
                    b = nal.doublePremiseTask(ct, truth, budget, stamp, false);
                }
            }
        }
    ...
    */
                    ...
                    if (Variables.findSubstitute(Symbols.VAR_DEPENDENT, s1, P2, res3, res4)) {
                        for (Term s2 : ((CompoundTerm) S1).term) {
                            ...
                            if (!s2.equals(s1) && (sentence.truth != null) && (belief.truth != null)) {
                                ...
                                nal.doublePremiseTask((CompoundTerm)s2, truth, budget, stamp, false);
                            }
                        }
                    }
                }
    ...
    static boolean introVarSameSubjectOrPredicate(final Sentence originalMainSentence, final Sentence subSentence, final Term component, final Term content, final int index, final NAL nal) {
        ...
        if ((component instanceof Inheritance && content instanceof Inheritance)
            ...
            nal.doublePremiseTask(T, truth, budget, nal.newStamp(originalMainSentence, subSentence), false);
            return true;
        }
        return false;
    }
