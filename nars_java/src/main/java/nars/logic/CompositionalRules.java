...
public final class CompositionalRules {
    ...
    public static final Variable depIndVar1 = new Variable(Parameters.DEBUG ? "#di1" : "#3");
    public static final Variable depIndVar2 = new Variable(Parameters.DEBUG ? "#di2" : "#4");
