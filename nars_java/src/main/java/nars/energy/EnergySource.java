...
public interface EnergySource  {
    ...
    default public double send(EnergyTarget target, double x) {
    ...
    public static class DefaultEnergyBuffer extends AtomicDouble implements EnergySource, EnergyTarget {
