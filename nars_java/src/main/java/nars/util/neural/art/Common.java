...
public class Common   
{
    /**
             ...
             */
    static public int instanceInSequence(ArrayList<ArrayList<Integer>> prototypesSequence, int instanceI) {
    ...
    /**
             ...
             **/
    static public int findItem(ArrayList<DynamicVector<Float>> samples, DynamicVector<Float> instance, boolean mustFind) {
        int index, i;
        index = -1;
