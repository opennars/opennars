...
//
//
//public class CurveBag2<E extends Item<K>, K> extends Bag<E,K> implements Equality<E> {
//     
//    final float MASS_EPSILON = 1e-5f;
//    
//    public static class Tag<K> implements Comparable {
//        public final K k;
//        public final BudgetValue b;
//
//        public Tag(K k, BudgetValue b) {
//            this.k = k;
//            this.b = b;
//        }
//
...
//            if (o instanceof BudgetValue) {
//                BudgetValue a = (BudgetValue)o;
//                float ap = a.getPriority();
//                float bp = b.getPriority();                
//                if (ap == bp) return a.hashCode() - o.hashCode();                
...
//                float ap = a.getPriority();
//                float bp = b.getPriority();                
//                if (ap == bp) return k.hashCode() - t.k.hashCode();                
//                else if (ap < bp) return -1;
//                else return 1;                            
//            }
//            
...
//    private float x;
//        
//    public CurveBag2(int capacity, boolean randomRemoval) {
//        this(capacity, new FairPriorityProbabilityCurve(), randomRemoval);               
//    }
//    
//
//    
//    public CurveBag2(int capacity, BagCurve curve, boolean randomRemoval) {
//        super();
//        this.capacity = capacity;
//        this.randomRemoval = randomRemoval;        
//        this.curve = curve;
//                
//        items = new FastSortedSet(this);
//        
//        items.clear();
//                
//        if (randomRemoval)
...
//
//    
//    public static class CubicBagCurve implements nars.storage.CurveBag2.BagCurve {
//
...
//    public static class FairPriorityProbabilityCurve implements nars.storage.CurveBag2.BagCurve {
//
//        @Override public final double y(final double x) {
...
//    
//    
//    public static class QuadraticBagCurve implements nars.storage.CurveBag2.BagCurve {
//
//        @Override public final double y(final double x) {
//            //1.0 - ((1.0-x)^2)
//            // a function which has domain and range between 0..1.0 but
