...
public class Parameters {
    ...
    public static float TEMPORAL_JUDGEMENT_PRIORITY_INCREMENT=0.0f; //no gain anymore. how much =/> should be gained
    ...
    public static float IMMEDIATE_ETERNALIZATION_CONFIDENCE_MUL=0.0f; //no immediate eternalization anymore
