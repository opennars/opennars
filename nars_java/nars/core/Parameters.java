...
public class Parameters {
    ...
    public static float DERIVATION_PRIORITY_LEAK=1.0f; //https://groups.google.com/forum/#!topic/open-nars/y0XDrs2dTVs
    
    public static float DERIVATION_DURABILITY_LEAK=1.0f; //https://groups.google.com/forum/#!topic/open-nars/y0XDrs2dTVs
