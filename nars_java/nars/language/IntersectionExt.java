...
public class IntersectionExt extends CompoundTerm {
     ...
     */
    public Object clone() {
        return new IntersectionExt(getName(), (ArrayList<Term>) cloneList(components), isConstant(), complexity);
    }
    ...
    public static Term make(TreeSet<Term> set, Memory memory) {
        ...
        String name = makeCompoundName(InnateOperator.INTERSECTION_EXT, argument);
    ...
    public InnateOperator operator() {
        return InnateOperator.INTERSECTION_EXT;
    }
