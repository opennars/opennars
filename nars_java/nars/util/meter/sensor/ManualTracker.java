...
/**
 * A tracker type that allows direct manipulation of the numeric <i>value</i> to
 * be published to the associated {@link StatsSession}. Upon creation of a
 * {@link ManualTracker}, the value is set to <tt>0</tt>.
 *
 * @author The Stajistics Project
 */
public interface ManualTracker extends Sensor {
