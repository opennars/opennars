...
public class NonBlockingHashMap<TypeK, TypeV>
    ...
    private static final CHM chm(final Object[] kvs) {
        return (CHM) kvs[0];
    }

    private static final int[] hashes(final Object[] kvs) {
        return (int[]) kvs[1];
    }

    // Number of K,V pairs in the table
    private static final int len(final Object[] kvs) {
    ...
    private static final Object key(final Object[] kvs, final int idx) {
        return kvs[(idx << 1) + 2];
    }

    private static final Object val(final Object[] kvs, final int idx) {
        return kvs[(idx << 1) + 3];
    }

    private static final boolean CAS_key(final Object[] kvs, int idx, Object old, Object key) {
     ...
     */
    @Override
    public TypeV put(final TypeK key, final TypeV val) {
    ...
    private static final class CHM<TypeK, TypeV> {
        ...
        private final Object[] resize(NonBlockingHashMap topmap, Object[] kvs) {
            ...
            newkvs = MemoryManager.mallocObj(((1 << log2) << 1) + 2); // This can get expensive for big arrays
            newkvs[0] = new CHM(_size); // CHM in slot 0
            newkvs[1] = MemoryManager.malloc4(1 << log2); // hashes in slot 1
    ...
    // --- keySet --------------------------------------------------------------
    private final class SnapshotK implements Iterator<TypeK>, Enumeration<TypeK> {
        final SnapshotV _ss;
        ...
        public final TypeK nextElement() {
            return next();
        }
    ...
    abstract static class AbstractEntry<TypeK, TypeV> implements Map.Entry<TypeK, TypeV> {
        ...
        public boolean equals(final Object o) {
            ...
            final AbstractEntry e = (AbstractEntry) o;
            return eq(_key, e._key) && eq(_val, e._val);
        }
