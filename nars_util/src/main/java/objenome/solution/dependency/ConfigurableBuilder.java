...
public interface ConfigurableBuilder extends Builder {
     ...
     * you have a constructor that mixes Wrappers and primitives, like
     * below:<br/>
     * <br/><pre>
     * public AObject(int x, Integer i, Boolean b, boolean f) { ... }
     * </pre>
     *
     * @param value A parameter value to be used by a constructor. Must be a
     ...
     * @param key The dependency name, in other words, the key used to get a
