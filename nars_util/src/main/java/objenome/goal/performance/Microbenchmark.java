...
/** Simple microbenchmark that runs a method N times (with M warmups to avoid the effects of
 *  JIT in the early cycles), reporting total wall-time (real time as measured by clock) and
 *  delta memory consumption.
 */
