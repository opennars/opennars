...
abstract class AbstractPatriciaTrie<K, V> extends AbstractTrie<K, V> {
  ...
  @Override
  public TrieEntry<K, V> select(K key) {
    Reference<TrieEntry<K, V>> reference = new Reference();
  ...
  @Override
  public TrieEntry<K,V> select(K key, Cursor<? super K, ? super V> cursor) {
    Reference<TrieEntry<K, V>> reference = new Reference();
  ...
  private boolean selectR(TrieEntry<K, V> h, int bitIndex, 
      final K key, final Reference<TrieEntry<K, V>> reference) {
  ...
  private boolean selectR(TrieEntry<K,V> h, int bitIndex, 
      ...
      final Reference<TrieEntry<K, V>> reference) {
