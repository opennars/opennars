...
public class TriplePattern implements ClauseEntry {
     ...
     */
    private static boolean variantOf(Node n, Node p, Map<Node, Node> vmap) {
     ...
     */
    private static Node normalize(final Node node) {
...
//                object.equals(((TriplePattern)o).object);
    ...
    private static boolean nodeEqual(Node n1, Node n2) {
