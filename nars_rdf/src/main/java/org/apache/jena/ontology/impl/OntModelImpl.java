...
public class OntModelImpl extends ModelCom implements OntModel
{
     ...
     */
    static public final String owlSyntaxCheckerClassName = "org.apache.jena.ontology.tidy.JenaChecker";


    // Static variables
    //////////////////////////////////

    static private final Logger s_log = LoggerFactory.getLogger( OntModelImpl.class );
    ...
    protected final Set<String> m_imported = new HashSet<>();
