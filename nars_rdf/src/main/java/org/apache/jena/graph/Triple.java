...
public class Triple {
    ...
    public String toString(PrefixMapping pm) {
        return new StringBuilder().append(subj.toString(pm, true)).append(" @").append(pred.toString(pm, true)).append(' ').append(obj.toString(pm, true)).toString();
    }
    ...
    public boolean equals(final Object o) {
        return
                (o == this) ||
                        (o instanceof Triple && ((Triple) o).sameAs(subj, pred, obj));
    }
    ...
    public boolean matches(Triple other) {
        return (this == other) || other.matchedBy(subj, pred, obj);
    }
    ...
    public static abstract class Field {
        ...
        public static final Field fieldSubject = new Field() {
            ...
            @Override
            public Predicate<Triple> filterOn(final Node n) {
                return n.isConcrete()
                        ? x -> n.equals(x.subj)
                        : anyTriple
                        ;
