...
public class NAL5Test extends JavaNALTest {
    ...
    public void conditional_deduction() throws InvalidInputException {
        n.believe("<(&&,<robin --> [flying]>,<robin --> [withWings]>) ==> <robin --> bird>>").en("If robin can fly and has wings then robin is a bird.");
        n.believe("<robin --> [flying]>").en("robin can fly.");
        n.mustBelieve(100," <<robin --> [withWings]> ==> <robin --> bird>>",1.00f,0.81f).en("If robin has wings then robin is a bird");
        n.run();
    }
    ...
    public void conditional_deduction2() throws InvalidInputException {
        n.believe("<(&&,<robin --> [chirping]>,<robin --> [flying]>,<robin --> [withWings]>) ==> <robin --> bird>>").en("If robin can fly, has wings, and chirps, then robin is a bird");
        n.believe("<robin --> [flying]>").en("robin can fly.");
        n.mustBelieve(100," <(&&,<robin --> [chirping]>,<robin --> [withWings]>) ==> <robin --> bird>>",1.00f,0.81f).en("If robin has wings and chirps then robin is a bird.");
        n.run();
    }
    ...
    public void conditional_abduction2() throws InvalidInputException {
        n.believe("<(&&,<robin --> [withWings]>,<robin --> [chirping]>) ==> <robin --> bird>>").en("If robin is has wings and chirps, then robin is a bird");
        n.believe("<(&&,<robin --> [flying]>,<robin --> [withWings]>,<robin --> [chirping]>) ==> <robin --> bird>>").en("If robin can fly, has wings, and chirps, then robin is a bird");
    ...
    public void conditional_abduction3() throws InvalidInputException {
        n.believe("<(&&,<robin --> [flying]>,<robin --> [withWings]>) ==> <robin --> [living]>>",0.9f,0.9f).en("If robin can fly and it has wings, then robin is living.");
        n.believe("<(&&,<robin --> [flying]>,<robin --> bird>) ==> <robin --> [living]>>.").en("If robin can fly and robin is a bird then robin is living.");
        n.mustBelieve(100,"<<robin --> bird> ==> <robin --> [withWings]>>",1.00f,0.42f).en("I guess if robin is a bird, then robin has wings.");
        n.mustBelieve(100,"<<robin --> [withWings]> ==> <robin --> bird>>",0.90f,0.45f).en("I guess if robin has wings, then robin is a bird.");
        n.run();
    }
    ...
    public void conditional_induction() throws InvalidInputException {
        ...
        n.believe("<<robin --> [flying]> ==> <robin --> [withBeak]>>",0.9f,0.9f).en("If robin can fly then usually robin has a beak.");
        n.mustBelieve(100,"<(&&,<robin --> [chirping]>,<robin --> [withBeak]>) ==> <robin --> bird>>",1.00f,0.42f).en("I guess that if robin chirps and robin has a beak, then robin is a bird.");
        n.run();
    }
