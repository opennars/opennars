...
public class NAL6Test extends AbstractNALTester {
    ...
    public void variable_unification6() throws Narsese.NarseseException {
        ...
        tester.mustBelieve(cycles*12, "<(&&,<$1 --> flyer>,<($1,worms) --> food>) ==> <$1 --> [withWings]>>", 1.00f, 0.45f); //en("If something can fly and eats worms, then I guess it has wings.");
        tester.mustBelieve(cycles*12, "<<$1 --> [withWings]> ==> (&&,<$1 --> flyer>,<($1,worms) --> food>)>", 1.00f, 0.45f); //en("I guess if something has wings, then it can fly and eats worms.");
        tester.run();
    }
    ...
    public void variable_elimination6() throws Narsese.NarseseException {
        ...
        tester.mustBelieve(cycles*12, "<(&&,<{Tweety} --> [chirping]>,<({Tweety},worms) --> food>) ==> <{Tweety} --> bird>>", 1.00f, 0.81f); //en("If Tweety can chirp and eats worms, then it is a bird.");
        tester.run();
    }
