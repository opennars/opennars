...
//    }
     ...
     */
    public boolean link(Task t, NAR nar) {

        if (linkTask(t, nar))
            return linkTemplates(t.getBudget(), true, nar);  // recursively insert TermLink
     ...
     */
    public boolean linkTemplates(Budget b, boolean updateTLinks, NAR nar) {
