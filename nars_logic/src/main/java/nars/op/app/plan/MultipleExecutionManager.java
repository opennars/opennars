 ...
 */
public class MultipleExecutionManager extends NARReaction {
    ...
    public static class Execution implements Comparable<Execution> {
        ...
        private Truth desire;
        public final MultipleExecutionManager executive;
        final Memory memory;

        public Execution(final MultipleExecutionManager executive, Truth desire) {
        ...
        public Truth getDesireValue() {
            return desire;
        }
        

        public void setDesire(Truth desire) {
            this.desire = desire;
        }
