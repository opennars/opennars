...
public class Default2 extends NAR {
    ...
    public final DefaultCycle2 core;
    ...
    public Default2(int activeConcepts, int conceptsFirePerCycle, int termLinksPerCycle, int taskLinksPerCycle, Clock clock) {
    ...
    public Default2 nal(int maxNALlevel) {
    ...
    public Default2 setTaskLinkBagSize(int taskLinkBagSize) {
        this.taskLinkBagSize = taskLinkBagSize;
        return this;
    }

    public Default2 setTermLinkBagSize(int termLinkBagSize) {
...
//        new Wait()              // wait for a certain number of clock cycle
    ...
    public Default2(Memory memory, int activeConcepts, int conceptsFirePerCycle, int termLinksPerCycle, int taskLinksPerCycle) {
        super(memory);
    ...
    protected DefaultCycle2 initCore(int activeConcepts, int conceptsFirePerCycle, int termLinksPerCycle, int taskLinksPerCycle) {

        DefaultCycle2 c = initCore(
                activeConcepts,
                getDeriver(),
     ...
     */
    public static class DefaultCycle2 implements Serializable {
