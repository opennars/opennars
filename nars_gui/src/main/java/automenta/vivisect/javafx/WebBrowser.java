...
import automenta.vivisect.javafx.willow.browser.*;
import automenta.vivisect.javafx.willow.navigation.NavTools;
import automenta.vivisect.javafx.willow.util.DebugUtil;
...
//    }
    ...
    public void start(final Stage stage) throws MalformedURLException, UnsupportedEncodingException {
        ...
        */
        ...
        sidebar = new FlowPane(); //new NodeControlPane(core);
