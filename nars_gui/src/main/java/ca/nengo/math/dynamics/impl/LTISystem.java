 ...
 */
package ca.nengo.math.dynamics.impl;
...
public class LTISystem implements LinearSystem {
	 ...
	 * @return Ax + Bu
	 *
	 * @see ca.nengo.math.dynamics.DynamicalSystem#f(float, float[])
	 */
	 ...
	 * @return Cx + Du
	 *
	 * @see ca.nengo.math.dynamics.DynamicalSystem#g(float, float[])
	 */
	...
	/**
	 * @see ca.nengo.math.dynamics.DynamicalSystem#getState()
	 */
	...
	/**
	 * @see ca.nengo.math.dynamics.DynamicalSystem#setState(float[])
	 */
	...
	/**
	 * @see ca.nengo.math.dynamics.DynamicalSystem#getInputDimension()
	 */
	...
	/**
	 * @see ca.nengo.math.dynamics.DynamicalSystem#getOutputDimension()
	 */
	...
	/**
	 * @see ca.nengo.math.dynamics.DynamicalSystem#getOutputUnits(int)
	 */
	...
	/**
	 * @see ca.nengo.math.dynamics.LinearSystem#getA(float)
	 */
	...
	/**
	 * @see ca.nengo.math.dynamics.LinearSystem#getB(float)
	 */
	...
	/**
	 * @see ca.nengo.math.dynamics.LinearSystem#getC(float)
	 */
	...
	/**
	 * @see ca.nengo.math.dynamics.LinearSystem#getD(float)
	 */
	...
	/**
	 * @see ca.nengo.math.dynamics.DynamicalSystem#clone()
	 */
