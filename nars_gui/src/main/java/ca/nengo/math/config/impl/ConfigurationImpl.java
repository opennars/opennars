...
public class ConfigurationImpl implements Configuration {
	...
	/**
	 * @see ca.nengo.math.config.Configuration#getConfigurable()
	 */
	...
	/**
	 * @see ca.nengo.math.config.Configuration#getPropertyNames()
	 */
	...
	/**
	 * @see ca.nengo.math.config.Configuration#getProperty(java.lang.String)
	 */
