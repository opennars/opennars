...
public final class ClassRegistry {
	...
	private ClassRegistry() {
		...
		String[] types = loadList(System.getProperty(TYPES_LOCATION_PROPERTY, "ca/nengo/math/config/types.txt"));
		...
		String[] impls = loadList(System.getProperty(IMPLS_LOCATION_PROPERTY, "ca/nengo/math/config/impls.txt"));
