 ...
 */
package ca.nengo.math.config.impl;

import ca.nengo.math.config.Configuration;
import ca.nengo.math.config.NamedValueProperty;
 ...
 *
 * <p>Use of this class is analogous to {@link ca.nengo.math.config.impl.ListPropertyImpl}. See
...
public class NamedValuePropertyImpl extends AbstractProperty implements NamedValueProperty {
	 ...
	 * @see ca.nengo.math.config.NamedValueProperty#getValue(java.lang.String)
	 */
	...
	/**
	 * @see ca.nengo.math.config.NamedValueProperty#getValueNames()
	 */
	...
	/**
	 * @see ca.nengo.math.config.NamedValueProperty#isNamedAutomatically()
	 */
	...
	/**
	 * @see ca.nengo.math.config.NamedValueProperty#removeValue(java.lang.String)
	 */
	...
	/**
	 * @see ca.nengo.math.config.Property#isFixedCardinality()
	 */
	...
	/**
	 * @see ca.nengo.math.config.impl.AbstractProperty#isMutable()
	 */
