...
import ca.nengo.math.config.ListProperty;
...
public class TemplateArrayProperty extends AbstractProperty implements ListProperty {
	...
	/**
	 * @see ca.nengo.math.config.ListProperty#addValue(java.lang.Object)
	 */
	...
	/**
	 * @see ca.nengo.math.config.ListProperty#getNumValues()
	 */
	...
	/**
	 * @see ca.nengo.math.config.ListProperty#getValue(int)
	 */
	...
	/**
	 * @see ca.nengo.math.config.ListProperty#insert(int, java.lang.Object)
	 */
	...
	/**
	 * @see ca.nengo.math.config.ListProperty#remove(int)
	 */
	...
	/**
	 * @see ca.nengo.math.config.ListProperty#setValue(int, java.lang.Object)
	 */
	...
	/**
	 * @see ca.nengo.math.config.ListProperty#getDefaultValue()
	 */
