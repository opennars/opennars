...
import ca.nengo.math.config.ConfigurationHandler;
import ca.nengo.math.config.IconRegistry;
...
public abstract class BaseHandler implements ConfigurationHandler {
	 ...
	 *
	 * @see ca.nengo.math.config.ConfigurationHandler#getEditor(java.lang.Object, ConfigurationChangeListener, JComponent)
	 */
