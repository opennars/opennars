 ...
 */
package ca.nengo.math.neural.nef.impl;

import Jama.Matrix;
import ca.nengo.math.ApproximatorFactory;
import ca.nengo.math.Function;
import ca.nengo.math.LinearApproximator;
import ca.nengo.math.dynamics.LinearSystem;
import ca.nengo.math.dynamics.impl.CanonicalModel;
...
import ca.nengo.math.neural.nef.DecodableGroup;
import ca.nengo.math.neural.plasticity.impl.PlasticGroupImpl;
import ca.nengo.sim.model.*;
import ca.nengo.sim.model.impl.FunctionInput;
...
public class DecodableGroupImpl extends PlasticGroupImpl implements DecodableGroup {
	...
	/**
	 * @see ca.nengo.math.neural.nef.DecodableGroup#addDecodedOrigin(java.lang.String, ca.nengo.math.Function[], java.lang.String, ca.nengo.sim.model.Network, ca.nengo.util.Probe, float, float)
	 */
	...
	/**
	 * @see ca.nengo.math.neural.nef.DecodableGroup#addDecodedOrigin(java.lang.String, ca.nengo.math.Function[], java.lang.String, ca.nengo.sim.model.Network, ca.nengo.util.Probe, ca.nengo.sim.model.NTarget, float[][], float)
	 */
    public NSource addDecodedOrigin(String name, Function[] functions, String nodeOrigin, Network environment,
     ...
     * @see ca.nengo.math.neural.nef.NEFGroup#addDecodedTermination(java.lang.String, float[][], float, boolean)
     */
     ...
     * @throws StructuralException if termination name is taken
     * @see ca.nengo.math.neural.nef.NEFGroup#addDecodedTermination(java.lang.String, float[][], float[], float[], float, boolean)
     */
    ...
    /**
     * @see ca.nengo.math.neural.nef.NEFGroup#removeDecodedTermination(java.lang.String)
     */
	...
	/**
	 * @see ca.nengo.math.neural.nef.DecodableGroup#doneOrigins()
	 */
	...
	/**
	 * @see ca.nengo.sim.model.Node#getSource(java.lang.String)
	 */
	@Override
    ...
    /**
     * @see ca.nengo.sim.model.Node#getTarget(java.lang.String)
     */
    @Override
	...
	/**
	 * @see ca.nengo.sim.model.Group#getSources()
	 */
	@Override
    ...
    /**
     * @see ca.nengo.sim.model.Group#getTargets()
     */
    @Override
