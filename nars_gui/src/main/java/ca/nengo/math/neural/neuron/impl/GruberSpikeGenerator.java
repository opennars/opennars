...
import ca.nengo.math.dynamics.impl.AbstractDynamicalSystem;
import ca.nengo.math.dynamics.impl.RK45Integrator;
import ca.nengo.math.impl.LinearCurveFitter;
import ca.nengo.math.neural.impl.SpikeOutputImpl;
...
//		Plotter.plot(current, rt, "current -> rt");
	...
	/**
	 * @see ca.nengo.math.neural.neuron.SpikeGenerator#run(float[], float[])
	 */
	...
	/**
	 * @see ca.nengo.sim.model.SimulationMode.ModeConfigurable#getMode()
	 */
	...
	/**
	 * @see ca.nengo.sim.model.SimulationMode.ModeConfigurable#setMode(ca.nengo.sim.model.SimulationMode)
	 */
	...
	public static class GruberDynamics extends AbstractDynamicalSystem {
		 ...
		 *
		 * @see ca.nengo.math.dynamics.impl.AbstractDynamicalSystem#f(float, float[])
		 */
		...
		/**
		 * @see ca.nengo.math.dynamics.impl.AbstractDynamicalSystem#g(float, float[])
		 */
		...
		/**
		 * @see ca.nengo.math.dynamics.impl.AbstractDynamicalSystem#getInputDimension()
		 */
		...
		/**
		 * @see ca.nengo.math.dynamics.impl.AbstractDynamicalSystem#getOutputDimension()
		 */
