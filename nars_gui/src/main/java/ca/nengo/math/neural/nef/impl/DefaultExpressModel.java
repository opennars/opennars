...
public class DefaultExpressModel extends AdditiveGaussianExpressModel {
    ...
    /**
     * @see ca.nengo.math.neural.nef.impl.AdditiveGaussianExpressModel#getNoiseSD(float[])
     */
    ...
    /**
     * @see ca.nengo.math.neural.nef.impl.AdditiveGaussianExpressModel#getDistortion(float[])
     */
