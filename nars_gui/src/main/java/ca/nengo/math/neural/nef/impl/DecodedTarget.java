...
public class DecodedTarget implements NTarget<InstantaneousOutput>, Resettable, Probeable {
	 ...
	 *
	 * @see ca.nengo.sim.model.NTarget#apply(ca.nengo.sim.model.InstantaneousOutput)
	 */
	...
	/**
	 * @see ca.nengo.sim.model.NTarget#getName()
	 */
	...
	/**
	 * @see ca.nengo.sim.model.NTarget#getDimensions()
	 */
	...
	/**
	 * @see ca.nengo.sim.model.NTarget#getModulatory()
	 */
	...
	/**
	 * @see ca.nengo.sim.model.NTarget#setModulatory(boolean)
	 */
	...
	/**
	 * @see ca.nengo.sim.model.NTarget#getNode()
	 */
	public Node getNode() {
		return myNode;
	}
