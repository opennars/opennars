...
import ca.nengo.math.neural.nef.NEFGroupFactory;
import ca.nengo.math.neural.nef.NEFNode;
import ca.nengo.math.neural.neuron.Neuron;
import ca.nengo.math.neural.neuron.impl.LIFNeuronFactory;
import ca.nengo.sim.model.Node;
import ca.nengo.sim.model.SimulationMode;
import ca.nengo.sim.model.StructuralException;
import ca.nengo.sim.model.impl.NodeFactory;
...
public class NEFGroupFactoryImpl implements NEFGroupFactory, java.io.Serializable {
	...
	/**
	 * @see ca.nengo.math.neural.nef.NEFGroupFactory#getApproximatorFactory()
	 */
	...
	/**
	 * @see ca.nengo.math.neural.nef.NEFGroupFactory#getEncoderFactory()
	 */
	...
	/**
	 * @see ca.nengo.math.neural.nef.NEFGroupFactory#getEvalPointFactory()
	 */
	...
	/**
	 * @see ca.nengo.math.neural.nef.NEFGroupFactory#getNodeFactory()
	 */
	...
	/**
	 * @see ca.nengo.math.neural.nef.NEFGroupFactory#make(java.lang.String, int, int)
	 */
	...
	/**
	 * @see ca.nengo.math.neural.nef.NEFGroupFactory#make(java.lang.String, int, float[])
	 */
	...
	/**
	 * @see ca.nengo.math.neural.nef.NEFGroupFactory#make(java.lang.String, int, int, java.lang.String, boolean)
	 */
...
//        }
	...
	/**
	 * @see ca.nengo.math.neural.nef.NEFGroupFactory#setApproximatorFactory(ca.nengo.math.ApproximatorFactory)
	 */
	...
	/**
	 * @see ca.nengo.math.neural.nef.NEFGroupFactory#setEncoderFactory(ca.nengo.util.VectorGenerator)
	 */
	...
	/**
	 * @see ca.nengo.math.neural.nef.NEFGroupFactory#setEvalPointFactory(ca.nengo.util.VectorGenerator)
	 */
	...
	/**
	 * @see ca.nengo.math.neural.nef.NEFGroupFactory#setNodeFactory(ca.nengo.sim.model.impl.NodeFactory)
	 */
