...
import ca.nengo.math.neural.neuron.ExpandableSynapticIntegrator;
...
import ca.nengo.sim.model.impl.DelayedLinearExponentialTarget;
import ca.nengo.sim.model.impl.LinearExponentialTarget;
...
public class LinearSynapticIntegrator implements ExpandableSynapticIntegrator {
	...
	/**
	 * @see ca.nengo.math.neural.neuron.SynapticIntegrator#run(float, float)
	 */
	...
	/**
	 * @see ca.nengo.math.neural.neuron.SynapticIntegrator#getTerminations()
	 */
	...
	/**
	 * @see ca.nengo.math.neural.neuron.ExpandableSynapticIntegrator#addTermination(java.lang.String, float[], float, boolean)
	 */
	...
	/**
	 * @see ca.nengo.math.neural.neuron.ExpandableSynapticIntegrator#removeTermination(java.lang.String)
	 */
	...
	/**
	 * @see ca.nengo.math.neural.neuron.SynapticIntegrator#getTermination(java.lang.String)
	 */
	...
	public static class Factory implements SynapticIntegratorFactory {
		...
		/**
		 * @see ca.nengo.math.neural.neuron.impl.SynapticIntegratorFactory#make()
		 */
