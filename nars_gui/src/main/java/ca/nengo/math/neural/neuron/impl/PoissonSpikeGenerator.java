...
//	}
	...
	public static class LinearFactory implements SpikeGeneratorFactory {
		...
		/**
		 * @see ca.nengo.math.neural.neuron.impl.SpikeGeneratorFactory#make()
		 */
	...
	public static class LinearNeuronFactory implements NodeFactory {
		...
		/**
		 * @see ca.nengo.sim.model.impl.NodeFactory#make(java.lang.String)
		 */
		...
		/**
		 * @see ca.nengo.sim.model.impl.NodeFactory#getTypeDescription()
		 */
