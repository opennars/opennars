...
import ca.nengo.math.neural.neuron.impl.SpikeGeneratorSource;
import ca.nengo.math.neural.neuron.impl.SpikingNeuron;
import ca.nengo.math.neural.plasticity.impl.*;
...
public class NEFGroupImpl extends DecodableGroupImpl implements NEFGroup {
	...
	/**
	 * @see ca.nengo.math.neural.nef.NEFGroup#getRadii()
	 */
	...
	/**
	 * @see ca.nengo.math.neural.nef.NEFGroup#getDimension()
	 */
    @Override
	...
	/**
	 * @see ca.nengo.math.neural.nef.NEFGroup#getEncoders()
	 */
	...
	/**
	 * @see ca.nengo.math.neural.nef.NEFGroup#addDecodedOrigin(java.lang.String, Function[], String)
	 */
	...
	/**
	 * @see ca.nengo.math.neural.nef.NEFGroup#addBiasOrigin(ca.nengo.sim.model.NSource, int, java.lang.String, boolean)
	 */
   ...
   /**
     ...
     * @see ca.nengo.sim.model.ExpandableNode#addTarget(java.lang.String, float[][], float, boolean)
     */
	...
	/**
	 * @see ca.nengo.math.neural.nef.NEFGroup#addBiasTerminations(DecodedTarget, float, float[][], float[][])
	 */
	...
	/**
	 * @see ca.nengo.sim.model.Group#run(float, float)
	 */
	@Override
	...
	/**
	 * @see ca.nengo.sim.model.Group#setMode(ca.nengo.sim.model.SimulationMode)
	 */
	@Override
