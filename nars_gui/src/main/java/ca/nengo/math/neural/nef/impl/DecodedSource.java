...
import ca.nengo.math.config.Configurable;
...
import ca.nengo.math.neural.nef.ExpressModel;
import ca.nengo.math.neural.nef.NEFGroup;
import ca.nengo.math.neural.plasticity.ShortTermPlastic;
...
public class DecodedSource implements NSource<InstantaneousOutput>, Resettable, SimulationMode.ModeConfigurable, Noise.Noisy, Configurable, ShortTermPlastic {
	...
	/**
	 * @see ca.nengo.math.config.Configurable#getConfiguration()
	 */
	...
	/**
	 * @see ca.nengo.sim.model.NSource#getName()
	 */
	...
	/**
	 * @see ca.nengo.sim.model.NSource#getDimensions()
	 */
	...
	/**
	 * @see ca.nengo.math.neural.plasticity.ShortTermPlastic#getSTPDynamics()
	 */
	...
	/**
	 * @see ca.nengo.math.neural.plasticity.ShortTermPlastic#setSTPDynamics(ca.nengo.math.dynamics.DynamicalSystem)
	 */
	...
	/**
	 * @see ca.nengo.sim.model.NSource#get()
	 */
	...
	/**
	 * @see ca.nengo.sim.model.NSource#setValues()
	 */
	...
	/**
	 * @see ca.nengo.sim.model.NSource#getNode()
	 */
	public Node getNode() {
		return myNode;
	}
