...
package ca.nengo.math.neural.impl;
...
public class PreciseSpikeOutputImpl implements PreciseSpikeOutput {
	...
	/**
	 * @see ca.nengo.math.neural.PreciseSpikeOutput#getSpikeTimes()
	 */
	...
	/**
	 * @see ca.nengo.math.neural.SpikeOutput#getValues()
	 */
	...
	/**
	 * @see ca.nengo.sim.model.InstantaneousOutput#getUnits()
	 */
	...
	/**
	 * @see ca.nengo.sim.model.InstantaneousOutput#getDimension()
	 */
	...
	/**
	 * @see ca.nengo.sim.model.InstantaneousOutput#getTime()
	 */
