 ...
 */
package ca.nengo.math.neural.neuron.impl;

import ca.nengo.math.neural.SpikeOutput;
...
import ca.nengo.sim.model.impl.BasicSource;
...
public class SpikingNeuron implements Neuron, Probeable, NEFNode {
	...
	/**
	 * @see ca.nengo.math.neural.neuron.Neuron#run(float, float)
	 */
	...
	/**
	 * @see ca.nengo.math.neural.neuron.Neuron#getSources()
	 */
	...
	/**
	 * @see ca.nengo.math.neural.neuron.Neuron#getSource(java.lang.String)
	 */
...
//		assert (name.equals(Neuron.AXON) || name.equals(CURRENT)); //this is going to be called a lot, so let's skip the exception
	...
	/**
	 * @see ca.nengo.math.neural.neuron.Neuron#setMode(ca.nengo.sim.model.SimulationMode)
	 */
	...
	/**
	 * @see ca.nengo.math.neural.neuron.Neuron#getMode()
	 */
	...
	/**
	 * @see ca.nengo.sim.model.Node#getTargets()
	 */
	...
	/**
	 * @see ca.nengo.math.neural.nef.NEFNode#setRadialInput(float)
	 */
