 ...
 */
package ca.nengo.math.neural.plasticity.impl;
...
public class PlasticGroupImpl extends GroupImpl implements TaskSpawner {
    ...
    /**
     * @see ca.nengo.math.neural.plasticity.PlasticGroup#setPlasticityInterval(float)
     */
    ...
    /**
     * @see ca.nengo.math.neural.plasticity.PlasticGroup#getPlasticityInterval()
     */
