...
import ca.nengo.math.neural.PreciseSpikeOutput;
...
public abstract class AbstractGroup implements Group<Node>, Probeable, VisiblyChanges {
	...
	/**
	 * @see ca.nengo.sim.model.Group#name()
	 */
    public String name() {
		return myName;
	}
	...
	/**
	 * @see ca.nengo.sim.model.Group#getNodes()
	 */
	 ...
	 *
	 * @see ca.nengo.sim.model.Group#getMode()
	 */
	...
	/**
	 * @see ca.nengo.sim.model.Group#getSource(java.lang.String)
	 */
	...
	/**
	 * @see ca.nengo.sim.model.Group#getTarget(java.lang.String)
	 */
     ...
     * @see ca.nengo.sim.model.ExpandableNode#removeTarget(java.lang.String)
     */
	...
	/**
	 * @see ca.nengo.sim.model.Node#getSources()
	 */
	...
	/**
	 * @see ca.nengo.sim.model.Group#collectSpikes(boolean)
	 */
	...
	/**
	 * @see ca.nengo.sim.model.Group#isCollectingSpikes()
	 */
	...
	/**
	 * @see ca.nengo.sim.model.Group#getSpikePattern()
	 */
