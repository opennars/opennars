...
public class MeterVisOld extends TimelineVis {
    ...
    public MeterVisOld(NAR n, TemporalMetrics<Object> metrics) {
     ...
     * Chart.BAR_CENTERED
     */
    public MeterVisOld(EventEmitter nar, TemporalMetrics<Object> meters) {
