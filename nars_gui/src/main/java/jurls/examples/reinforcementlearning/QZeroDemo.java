...
public class QZeroDemo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        brainEpsilonTextField.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
        ...
        cnfFunctionMenuItem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    private void cnfFunctionMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cnfFunctionMenuItemActionPerformed
    ...
    private void brainEpsilonTextFieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_brainEpsilonTextFieldActionPerformed
        brainParameters.epsilon = Double.parseDouble(brainEpsilonTextField.getText());
