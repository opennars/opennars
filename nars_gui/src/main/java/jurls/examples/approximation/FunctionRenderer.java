 ...
 * @author thorsten
 */
public class FunctionRenderer extends javax.swing.JPanel {

    public final List<RenderFunction> renderFunctions = new ArrayList<>();
    ...
    protected void paintComponent(Graphics g) {
        ...
        for (RenderFunction rf : renderFunctions) {
