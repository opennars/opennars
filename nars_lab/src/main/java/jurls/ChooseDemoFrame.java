 ...
 * @author thorsten2
 */
public class ChooseDemoFrame extends javax.swing.JFrame {

    /**
     * Creates new form ChooseDemoFrame
     */
    public ChooseDemoFrame() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChooseDemoFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ChooseDemoFrame().setVisible(true);
            }
        });
    }
