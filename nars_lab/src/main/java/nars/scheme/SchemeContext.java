...
public class SchemeContext extends SchemeUtils {
    public Object vars;
    public Object vals;
    public SchemeContext parent;

    /**
     * A constructor to extend an environment with var/val pairs.
     */
    public SchemeContext(Object vars, Object vals, SchemeContext parent) {
        this.vars = vars;
        this.vals = vals;
        this.parent = parent;
     ...
     * Find the value of a symbol, in this environment or a parent.
     */
    public Object lookupRecursive(String symbol) {
    ...
    public Object set(Object var, Object val) {
        ...
        while (true) {
            if (!(var instanceof String))
                return other.error("Attempt to set a non-symbol: "
                        + Pair.stringify(var));
            ...
            while (varList != null) {
                if (other.first(varList) == symbol) {
                    return other.setFirst(valList, val);
                } else if (other.rest(varList) == symbol) {
                    return other.setRest(valList, val);
                } else {
                    varList = other.rest(varList);
                    valList = other.rest(valList);
                }
     ...
     * Set the value of an existing variable *
     */
    public Object setRecursive(Object var, Object val) {
        if (!(var instanceof String))
    ...
    public SchemeContext defPrim(String name, int id, int minArgs) {
        define(name, new Primitive(id, minArgs, minArgs));
        return this;
    }

    public SchemeContext defPrim(String name, int id, int minArgs, int maxArgs) {
     ...
     */
    static boolean numberArgsOK(Object vars, Object vals) {
        return ((vars == null && vals == null)
                || (vars instanceof String)
                || (vars instanceof IPair && vals instanceof IPair
                && numberArgsOK(((IPair) vars).rest(), ((IPair) vals).rest())));
    }
