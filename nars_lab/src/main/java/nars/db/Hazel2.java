...
hazelcast.client.event.queue.capacity	1000000	string	Default value of the capacity of executor that handles incoming event packets.
             ...
             */
//            SerializationConfig serial = cfg.getSerializationConfig();
//
//            NativeMemoryConfig mem = cfg.getNativeMemoryConfig();
//            mem.setEnabled(true);
//
//
//            SecurityConfig sec = cfg.getSecurityConfig();
//            sec.setEnabled(false);
//
//            ServicesConfig serv = cfg.getServicesConfig();
//            serv.clear();
