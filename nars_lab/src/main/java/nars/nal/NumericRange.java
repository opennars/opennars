...
public class NumericRange {
    ...
    public void adaptiveContrast(double rate, double target) {        
        double range = (max - min) * rate; //rate used here is in a slightly different context than below; we may want two different parameters. this is the amount to shrink the range window around the target, and the below rate is how quickly the window changes.
