...
public class NARio extends Run {
    ...
    int inputRefresh = 1500;
    final float gameTimePerMemoryCycle = 0.03f;
...
//                                            ")) --> space>. :|:";
                ...
                //System.out.println(Arrays.toString(keyWeight));
                for (final int k : keys) {

                    boolean humanPressed = mario.keys[k];
