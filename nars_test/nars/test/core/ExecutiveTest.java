...
public class ExecutiveTest {
    ...
    public void testTaskExecution() {
        ...
        e.tasks.add(new TaskExecution(e, new TruthValue(1.0f, 0.5f)));
        e.tasks.add(new TaskExecution(e, new TruthValue(1.0f, 0.05f)));
        ...
        e.tasks.add(new TaskExecution(e, new TruthValue(1.0f, 0.06f)));
        assertEquals(2, e.tasks.size());
    }
