...
public class NALTest2  {

    /** reads an example file line-by-line, before being processed, to extract expectations */    
    public static List<Expect> getExpectations(NAR n, String example) {
        ...
        for (String s : lines) {
            ...
            if (s.indexOf(expectOutContains)==0) {
                ...
                Expect ex = new ExpectContains(n, e);
    ...
    abstract public static class Expect implements Output {
    ...
    public static class ExpectContains extends Expect {
        ...
        public ExpectContains(NAR nar, String containing) {
            super(nar);
    ...
    protected void testNAL(final String path) {
        @Deprecated int minCycles = 300; //TODO reduce this to one or zero
        ...
        List<Expect> extractedExpects = getExpectations(n, example);
    ...
    public NALTest2(String scriptPath) {        
    ...
    public static void main(String[] args) {
        ...
        Result result = org.junit.runner.JUnitCore.runClasses(NALTest2.class);
