 ...
 */
public final class Structure implements PTerm {
    ...
    * @return either a new {@link Structure}, a new {@link PList} or {@link EmptyList#EMPTY_LIST}
    */
   public static PTerm createStructure(String functor, PTerm[] args) {
      if (args.length == 0) {
   ...
   /**
    * Private constructor to force use of {@link #createStructure(String, PTerm[])}
    * 
    * @param immutable is this structure immutable (i.e. are all it's arguments known to be immutable)?
    */
   private Structure(String functor, PTerm[] args, boolean immutable) {
