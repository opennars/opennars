...
//    }
    ...
    public boolean get_operators_list_1(Term argument) {
        ...
        while (it.hasNext()) {
            Operator o = it.next();
            list = new Struct(new Struct("op", new nars.prolog.Int(o.prio),
    ...
    public boolean integer_1(Term t) {
        if (!(t.getTerm()  instanceof Number))
            return false;
        nars.prolog.Number n = (nars.prolog.Number) t.getTerm();
        return (n.isInteger());
    }
    ...
    public boolean expression_equality_2(Term arg0, Term arg1)
        ...
        nars.prolog.Number val0n = (nars.prolog.Number) val0;
        nars.prolog.Number val1n = (nars.prolog.Number) val1;
    ...
    public boolean expression_greater_than_2(Term arg0, Term arg1)
        ...
        if (val1 == null || !(val1 instanceof Number))
            throw PrologError.type_error(engine.getEngineManager(), 2,
                    "evaluable", arg1.getTerm());
        return expression_greater_than((nars.prolog.Number) val0,
                (nars.prolog.Number) val1);
    }
    ...
    private boolean expression_greater_than(nars.prolog.Number num0,
            nars.prolog.Number num1) {
    ...
    public boolean expression_less_than_2(Term arg0, Term arg1)
        ...
        if (val1 == null || !(val1 instanceof Number))
            throw PrologError.type_error(engine.getEngineManager(), 2,
                    "evaluable", arg1.getTerm());
        return expression_less_than((nars.prolog.Number) val0,
                (nars.prolog.Number) val1);
    }
    ...
    private boolean expression_less_than(nars.prolog.Number num0,
            nars.prolog.Number num1) {
        if (num0.isInteger() && num1.isInteger()) {
//            return num0.intValue() < num1.intValue();
            return num0.longValue() < num1.longValue();
    ...
    public Term expression_minus_1(Term arg0) {
        ...
        if (val0 != null && val0 instanceof Number) {
            ...
            } else if (val0n instanceof nars.prolog.Double) {
                return new nars.prolog.Double(val0n.doubleValue() * -1);
            } else if (val0n instanceof nars.prolog.Long) {
                return new nars.prolog.Long(val0n.longValue() * -1);
            } else if (val0n instanceof nars.prolog.Float) {
                return new nars.prolog.Float(val0n.floatValue() * -1);
            } else {
                return null;
            }
        } else {
    ...
    public Term expression_bitwise_not_1(Term arg0) {
        ...
        if (val0 != null && val0 instanceof Number) {
            ...
            return new nars.prolog.Long(~((nars.prolog.Number) val0).longValue());
        } else {
            return null;
        }
    }

    nars.prolog.Number getIntegerNumber(long num) {
        if (num > Integer.MIN_VALUE && num < Integer.MAX_VALUE)
            return new Int((int) num);
        else
            return new nars.prolog.Long(num);
    }
    ...
    public Term expression_plus_2(Term arg0, Term arg1) {
        ...
        if (val0 != null && val1 != null && val0 instanceof Number
            ...
            if (val0n.isInteger() && (val1n.isInteger()))
                ...
                return new nars.prolog.Double(val0n.doubleValue()
                        + val1n.doubleValue());
        } else
            return null;
    }
    ...
    public Term expression_pow_2(Term arg0, Term arg1) {
        ...
        if (val0 != null && val1 != null && val0 instanceof Number
            ...
            nars.prolog.Number val0n = (nars.prolog.Number) val0;
            nars.prolog.Number val1n = (nars.prolog.Number) val1;
            return new nars.prolog.Double(Math.pow(val0n.doubleValue(),
                    val1n.doubleValue()));
        } else {
            return null;
        }
    ...
    public Term expression_bitwise_shift_right_2(Term arg0, Term arg1) {
        ...
        if (val0 != null && val1 != null && val0 instanceof Number
            ...
            // CORRECTED BY ED ON JAN 28, 2011
            return new nars.prolog.Long(val0n.longValue() >> val1n.longValue());
        } else {
            return null;
        }
    }
    ...
    public boolean num_atom_2(Term arg0, Term arg1) throws PrologError {
        ...
        if (arg1 instanceof Var) {
            ...
            if (term == null) {
                try {
                    term = new nars.prolog.Double(java.lang.Double
                            .parseDouble(st2));
                } catch (Exception ex) {
                }
            }
