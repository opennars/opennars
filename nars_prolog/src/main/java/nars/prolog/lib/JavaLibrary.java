...
//            	String[] listOfPaths = null;
            ...
            if (what instanceof Number) {
                ...
                } else if (wn instanceof nars.prolog.Double) {
                    field.setDouble(obj, wn.doubleValue());
                } else if (wn instanceof nars.prolog.Long) {
                    field.setLong(obj, wn.longValue());
                } else if (wn instanceof nars.prolog.Float) {
...
//            	String[] listOfPaths = null;
            ...
            if (fc.equals(Integer.TYPE) || fc.equals(Byte.TYPE)) {
                ...
                return unify(what, new nars.prolog.Int(value));
            } else if (fc.equals(java.lang.Long.TYPE)) {
                long value = field.getLong(obj);
                return unify(what, new nars.prolog.Long(value));
            } else if (fc.equals(java.lang.Float.TYPE)) {
                float value = field.getFloat(obj);
                return unify(what, new nars.prolog.Float(value));
            } else if (fc.equals(java.lang.Double.TYPE)) {
                double value = field.getDouble(obj);
                return unify(what, new nars.prolog.Double(value));
            } else {
