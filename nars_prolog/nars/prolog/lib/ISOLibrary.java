...
public class ISOLibrary extends Library {
    ...
    public Term sin_1(Term val) {
        ...
        if (val0 instanceof Number)
            return new nars.prolog.Double(Math.sin(((Number) val0)
                    .doubleValue()));
        return null;
    }
    ...
    public Term cos_1(Term val) {
        ...
        if (val0 instanceof Number)
            return new nars.prolog.Double(Math.cos(((Number) val0)
                    .doubleValue()));
        return null;
    }
    ...
    public Term exp_1(Term val) {
        ...
        if (val0 instanceof Number)
            return new nars.prolog.Double(Math.exp(((Number) val0)
                    .doubleValue()));
        return null;
    }
    ...
    public Term atan_1(Term val) {
        ...
        if (val0 instanceof Number)
            return new nars.prolog.Double(Math.atan(((Number) val0)
                    .doubleValue()));
        return null;
    }
    ...
    public Term log_1(Term val) {
        ...
        if (val0 instanceof Number)
            return new nars.prolog.Double(Math.log(((Number) val0)
                    .doubleValue()));
        return null;
    }
    ...
    public Term sqrt_1(Term val) {
        ...
        if (val0 instanceof Number)
            return new nars.prolog.Double(Math.sqrt(((Number) val0)
                    .doubleValue()));
        return null;
    }
    ...
    public Term abs_1(Term val) {
        ...
        if (val0 instanceof Int || val0 instanceof nars.prolog.Long)
            return new nars.prolog.Int(Math.abs(((Number) val0).intValue()));
        if (val0 instanceof nars.prolog.Double
                || val0 instanceof nars.prolog.Float)
            return new nars.prolog.Double(Math.abs(((Number) val0)
                    .doubleValue()));
        return null;
    }
    ...
    public Term float_integer_part_1(Term val) {
        ...
        if (val0 instanceof Number)
            return new nars.prolog.Double((long) Math.rint(((Number) val0)
                    .doubleValue()));
        return null;
    }
    ...
    public Term float_fractional_part_1(Term val) {
        ...
        if (val0 instanceof Number) {
            ...
            return new nars.prolog.Double(Math.abs(fl - Math.rint(fl)));
        }
        return null;
    }
    ...
    public Term float_1(Term val) {
        ...
        if (val0 instanceof Number)
            return new nars.prolog.Double(((Number) val0).doubleValue());
        return null;
    }
    ...
    public Term round_1(Term val) {
        ...
        if (val0 instanceof Number)
            return new nars.prolog.Long(Math.round(((Number) val0)
                    .doubleValue()));
        return null;
    }
    ...
    public Term div_2(Term v0, Term v1) throws PrologError {
        ...
        if (val0 instanceof Number && val1 instanceof Number)
            return new nars.prolog.Int(((Number) val0).intValue()
    ...
    public Term rem_2(Term v0, Term v1) {
        ...
        if (val0 instanceof Number && val1 instanceof Number) {
            return new nars.prolog.Double(Math.IEEEremainder(((Number) val0)
