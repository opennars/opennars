...
import static nars.language.Narsese.Symbols.ARGUMENT_SEPARATOR;
import static nars.language.Narsese.Symbols.BUDGET_VALUE_MARK;
import static nars.language.Narsese.Symbols.GOAL_MARK;
import static nars.language.Narsese.Symbols.INPUT_LINE_PREFIX;
import static nars.language.Narsese.Symbols.JUDGMENT_MARK;
...
import static nars.language.Narsese.Symbols.NativeOperator.SET_INT_CLOSER;
import static nars.language.Narsese.Symbols.NativeOperator.STATEMENT_CLOSER;
import static nars.language.Narsese.Symbols.OUTPUT_LINE_PREFIX;
import static nars.language.Narsese.Symbols.PREFIX_MARK;
import static nars.language.Narsese.Symbols.QUESTION_MARK;
import static nars.language.Narsese.Symbols.QUEST_MARK;
import static nars.language.Narsese.Symbols.STAMP_CLOSER;
import static nars.language.Narsese.Symbols.STAMP_OPENER;
import static nars.language.Narsese.Symbols.TRUTH_VALUE_MARK;
import static nars.language.Narsese.Symbols.VALUE_SEPARATOR;
import static nars.language.Narsese.Symbols.getCloser;
import static nars.language.Narsese.Symbols.getOpener;
import static nars.language.Narsese.Symbols.getRelation;
import static nars.language.Narsese.Symbols.isRelation;
...
import static nars.language.Narsese.Symbols.getOperator;
