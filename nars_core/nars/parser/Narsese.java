...
import static nars.parser.Symbols.ARGUMENT_SEPARATOR;
import static nars.parser.Symbols.BUDGET_VALUE_MARK;
import static nars.parser.Symbols.GOAL_MARK;
import static nars.parser.Symbols.INPUT_LINE_PREFIX;
import static nars.parser.Symbols.JUDGMENT_MARK;
...
import static nars.parser.Symbols.OUTPUT_LINE_PREFIX;
import static nars.parser.Symbols.PREFIX_MARK;
import static nars.parser.Symbols.QUESTION_MARK;
import static nars.parser.Symbols.QUEST_MARK;
import static nars.parser.Symbols.STAMP_CLOSER;
import static nars.parser.Symbols.STAMP_OPENER;
import static nars.parser.Symbols.TRUTH_VALUE_MARK;
import static nars.parser.Symbols.VALUE_SEPARATOR;
import static nars.parser.Symbols.getCloser;
import static nars.parser.Symbols.getOpener;
import static nars.parser.Symbols.getRelation;
import static nars.parser.Symbols.isRelation;
...
import static nars.parser.Symbols.getOperator;
