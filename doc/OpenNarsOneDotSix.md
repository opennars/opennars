...
In summary, there will be three types of operators in NARS that share the format _(oper, args)_:
...
Beside _satisfaction_, the system may use other system-level indicators:
